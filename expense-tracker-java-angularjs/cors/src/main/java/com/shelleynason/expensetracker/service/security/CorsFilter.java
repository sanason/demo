/*
 * Copied with modifications from Tomcat 7.0.42 class of the same name.
 * Changes:
 *   + Removed dependencies on juli logging and tomcat StringManager.
 *   + Switched configuration from init() to constructor.
 *
...
public final class CorsFilter implements Filter {
     ...
     */
    private final boolean decorateRequest;
     ...
     *            true if request should be decorated           
     */
    public CorsFilter(String allowedOrigins,
        ...
        if (allowedOrigins.trim().equals("*")) {
            ...
            this.allowedOrigins = parseStringToSet(allowedOrigins);
        }

        this.allowedHttpMethods = parseStringToSet(allowedHttpMethods);
        this.allowedHttpHeaders = parseStringToSet(allowedHttpHeaders.toLowerCase());
        this.exposedHeaders = parseStringToSet(exposedHeaders);
    ...
    public void doFilter(final ServletRequest servletRequest,
        ...
        if (!(servletRequest instanceof HttpServletRequest) ||
            ...
            throw new ServletException("CorsFilter only applies to HTTP requests.");
        }
    ...
    protected void handleSimpleCORS(final HttpServletRequest request,
        ...
        if (!(requestType == CorsFilter.CORSRequestType.SIMPLE ||
            ...
            throw new IllegalArgumentException("Request is not a simple or actual CORS request.");
        }
    ...
    protected void handlePreflightCORS(final HttpServletRequest request,
        ...
        if (requestType != CORSRequestType.PRE_FLIGHT) {
            throw new IllegalArgumentException("Request is not a pre-flight CORS request.");
        }
    ...
    protected static void decorateCORSProperties(
        ...
        if (corsRequestType == null) {
            throw new IllegalArgumentException("No CORS request type.");
        }
